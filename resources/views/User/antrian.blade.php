        ...
        <table class="min-w-full bg-white border border-[#0F67B1] text-center">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="px-4 py-2 border border-[#0F67B1]">{{ ucfirst($waiting->jenis_layanan) }}</td>
                    <td class="px-4 py-2 border border-[#0F67B1]">{{ Carbon::parse($waiting->start_date)->format('d/m/Y') }}</td>
                    <td class="px-4 py-2 border border-[#0F67B1]">{{ Carbon::parse($waiting->end_date)->format('d/m/Y') }}</td>
                </tr>
                @endforeach

                @if($waitings->isEmpty())
                <tr>
                    <td class="px-4 py-2 border border-[#0F67B1; text-center" colspan="8">Tidak ada data tersedia</td>
                </tr>
                @endif
            </tbody>
        </table>
