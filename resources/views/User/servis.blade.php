            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <table class="w-full border-collapse border border-[#0F67B1] mb-4">
                        <tr>
                            <td class="border border-[#0F67B1] px-4 py-2" style="width: 80%;">Ukuran besar (multi
                                position)</td>
                            <td class="border border-[#0F67B1] px-4 py-2 text-center" style="width: 20%;">100.000</td>
                        </tr>
                        <tr>
                            <td class="border border-[#0F67B1] px-4 py-2" style="width: 80%;">Ukuran kecil (travel
                                position)</td>
                    ...
                    <table class="w-full border-collapse border border-[#0F67B1] mb-4">
                        <tr>
                            <td class="border border-[#0F67B1] px-4 py-2" style="width: 80%;">Ukuran besar (toddler)
                            </td>
                    ...
                    <table class="w-full border-collapse border border-[#0F67B1] mb-4">
                        <tr>
                            <td class="border border-[#0F67B1] px-4 py-2" style="width: 80%;">Bedding set tanpa kelambu
                            </td>
                            <td class="border border-[#0F67B1] px-4 py-2 text-center" style="width: 20%;">40.000</td>
                        </tr>
                        <tr>
                            <td class="border border-[#0F67B1] px-4 py-2" style="width: 80%;">Bedding set dengan
                                kelambu</td>
        ...
        <div class="container mx-auto mb-10 scroll-mt-[20px] scroll-offset" id="Perlengkapan-Rumah-Tangga">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <table class="w-full border-collapse border border-[#0F67B1] mb-4">
                        <tr>
                            <td class="border border-[#0F67B1] px-4 py-2" style="width: 80%;">Kiloan (cuci setrika)
                            </td>
