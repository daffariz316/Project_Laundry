...
<section class="bg-[#F7FEFF]" id="content">
    <div class=" mx-auto flex flex-col md:flex-row items-start justify-between font-medium">
        <!-- Text Section -->
        <div class="md:w-1/2 space-y-4 px-4 md:pt-10 mb-10 text-[14px] md:text-[16px]" data-aos="fade-right" data-aos-duration="1500">
            <h1 class="text-4xl font-bold text-black text-[24px] md:text-[36px]">Cuci Hari Ini, Tampil Percaya Diri</h1>
            <p class="text-black">Yuma Laundry didirikan pada tahun 2018 di Malabar dan saat ini berlokasi di Artzimar 1. Awalnya menargetkan mahasiswa, usaha ini kini berfokus pada pelayanan rumah tangga, khususnya untuk perlengkapan bayi, serta menjalin kerja sama dengan klinik kecantikan.</p>
            ...
            <div class="space-x-4 mt-4">
                @if(Auth::check())
                    <a href="#" id="whatsapp-link" class="bg-[#0F67B1] text-white py-2 px-4 rounded-lg hover:bg-[#3FA2F6]">Hubungi Kami</a>
                @else
                    <button class="bg-[#0F67B1] text-white py-2 px-4 rounded-lg hover:bg-[#3FA2F6]" disabled>Hubungi kami</button>
                @endif
                <a href="{{ route('user.servis') }}" class="bg-[#0F67B1] text-white py-2 px-4 rounded-lg hover:bg-[#3FA2F6]">Layanan Kami</a>
            </div>
        </div>
        <!-- Image Section -->
        <div class="md:w-1/2 flex justify-end -mt-3" data-aos="fade-left" data-aos-duration="1500">
            <img src="{{asset('assets/img/Group_34.png')}}" alt="Mesin Cuci" class="max-w-[350px] w-auto hidden md:block"> <!-- Menggunakan kelas hidden dan md:block -->
        </div>
...
<section class="bg-[#96C9F4] py-7">
    <div class="container mx-auto text-center px-4">
        <h2 class="text-3xl font-bold mb-8 text-black text-[24px] md:text-[36px]">Daftar Barang yang Dapat Dicuci</h2>
        <div class="flex flex-col md:flex-row items-center gap-16 justify-center">
            <!-- Katalog 1 -->
            <div class="bg-white rounded-lg shadow-lg p-4 max-w-xs w-full" data-aos="zoom-in-right" data-aos-duration="1500" data-aos-anchor-placement="center-bottom">
                <h3 class="text-blue-500 font-semibold">KATALOG 1</h3>
                <p class="text-black font-bold">Perlengkapan Bayi</p>
                <div class="mt-4">
                    <a href="#">
                        <img src="{{asset('assets/img/perlengkapan bayi.jpg')}}" alt="Perlengkapan Bayi" class="rounded-lg w-full h-auto object-cover">
                    </a>
                </div>
            </div>
            <!-- Katalog 2 -->
            <div class="bg-white rounded-lg shadow-lg p-4 max-w-xs w-full" data-aos="zoom-in-left" data-aos-duration="1500" data-aos-anchor-placement="center-bottom">
                <h3 class="text-blue-500 font-semibold">KATALOG 2</h3>
                <p class="text-black font-bold">Perlengkapan Rumah Tangga</p>
                <div class="mt-4">
                    <a href="#">
                        <img src="{{asset('assets/img/perlengkapan r.tangga.jpg')}}" alt="Perlengkapan Rumah Tangga" class="rounded-lg w-full h-auto object-cover">
                    </a>
                </div>
            </div>
        </div>
    ...
    <div id="content">
        ...
        <section class="bg-[#F7FEFF]" id="content">
            ...
            data-aos-duration="1500" data-aos-delay="300" data-aos-anchor-placement="center-bottom">
                <h3 class="text-xl font-semibold text-black mb-4">Layanan Lengkap</h3>
                <p class="text-gray-700">Berbagai jenis layanan kami sediakan sesuai dengan kebutuhan pelanggan: Regular Ekonomis, Paket Exclusive, Laundry Khusus Pakaian Bayi, Laundry Batik, Laundry Bed Cover, Laundry Sepatu, Cuci Karpet dan Boneka serta berbagai layanan lainnya.</p>
            </div>
            <!-- Box 3: Garansi 100% Puas -->
            <div class="bg-[#D9D9D9] p-6 rounded-lg shadow-lg" data-aos="fade-up"
            data-aos-duration="2000" data-aos-delay="400" data-aos-anchor-placement="center-bottom">
                <h3 class="text-xl font-semibold text-black mb-4">Garansi 100% Puas</h3>
                <p class="text-gray-700">Kami memberikan jaminan kepuasan kepada para pelanggan dan jika pelanggan tidak merasa puas dengan hasil proses kami, kami akan mengulang proses TANPA BIAYA TAMBAHAN.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="bg-[#96C9F4] py-7">
    <div class="container mx-auto  p-4">
        <h2 class="text-3xl text-center font-bold mb-4 text-black text-[24px] md:text-[36px]">Mengenal Pemilik Yuma Laundry</h2>
        <div class="container mx-auto flex flex-col md:flex-row items-center justify-between">

            <!-- Gambar Pemilik -->
            <div class="md:w-1/3 flex justify-center" data-aos="flip-left" data-aos-duration="1500" data-aos-anchor-placement="center-bottom">
                <img src="{{asset('assets/img/foto kak iqbal.png')}}" alt="Pemilik Yuma Laundry" class="rounded-full w-48 h-48 object-cover">
            </div>
            <!-- Teks Pengantar -->
            <div class="md:w-2/3 -mb-2 md:mb-0 mt-4 md:mt-0 px-4"> <!-- Menambahkan mt-4 untuk mobile dan mb-4 untuk mobile -->

                <p class="text-black" data-aos="fade-right"
                data-aos-offset="300" data-aos-duration="2000 data-aos-anchor-placement="center-bottom">Iqbal, lulusan Ekonomi IPB angkatan 46, lahir tahun 1996 dan kini berusia 28 tahun. Ia memulai usahanya pada 2018 di Malabar dan sekarang berlokasi di Artzimar 1. Awalnya menargetkan mahasiswa, kini ia fokus pada rumah tangga, terutama dengan perlengkapan bayi, serta bermitra dengan klinik kecantikan sebagai vendor. Keunggulan usahanya terletak pada perhatian terhadap barang konsumen, seperti mendokumentasikan cucian sebelum diproses dan menawarkan harga seimbang dengan kualitas. Ia aktif memasarkan melalui Instagram Reels dan WhatsApp Business, meski masih menggunakan nota manual dan belum menerapkan kasir digital.</p>
            </div>
...
<script>
    ...
    @if(Auth::check())
        document.getElementById('whatsapp-link').addEventListener('click', function(e) {
            e.preventDefault();
            // Ambil username dari session Laravel
            let username = @json(Auth::user()->username);
            // Buat pesan otomatis WhatsApp
            let message = `Selamat datang di Yuma Laundry! Hai, salam kenal ${username}, saya ingin menanyakan terkait pelayanan .............. dan saya ingin melaundry disini.`;
            // Ganti link dengan WhatsApp URL yang berisi pesan otomatis
            let whatsappUrl = `https://wa.me/6281809591059?text=${encodeURIComponent(message)}`;
