    ...
    <header class="bg-[#F7FEFF] py-4 p-4">
        <div class="container mx-auto flex justify-between items-center">
            <div class="flex items-center space-x-3">
                <img src="{{asset('assets/img/logo yuma laundry.png')}}" alt="Logo Yuma Laundry" class="w-35 h-20">
            </div>
    ...
    <section class="bg-[#F7FEFF] ">
        <div class="container mx-auto flex flex-col md:flex-row items-start justify-between font-medium">
            ...
            <div class="md:w-1/2 flex justify-end -mt-10">
                <img src="{{asset('assets/img/Group 34.png')}}" alt="Mesin Cuci" class="w-full md:w-3/5">
            </div>
        </div>
    </section>
    <!-- Katalog Section -->
        ...
        <div class="container mx-auto text-center px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 justify-center">
                ...
                <div class="bg-white rounded-lg shadow-lg p-4 max-w-sm mx-auto">
                    ...
                    <div class="mt-4">
                        <a href="#">
                            <img src="{{asset('assets/img/perlengkapan_bayi.jpg')}}" alt="Perlengkapan Bayi" class="rounded-lg">
                        </a>
                    </div>
                </div>
                <!-- Katalog 2 -->
                <div class="bg-white rounded-lg shadow-lg p-4 max-w-sm mx-auto">
                    ...
                    <div class="mt-4">
                        <a href="#">
                            <img src="{{asset('assets/img/perlengkapan r.tangga.jpg')}}" alt="Perlengkapan Rumah Tangga"
                                class="rounded-lg">
                        </a>
                    </div>
                </div>
    ...
    <section class=" bg-[#F7FEFF] flex flex-col items-center py-7">
        ...
        <div class="w-full max-w-4xl">
            <iframe class="w-full h-96 border-0 rounded-lg"
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3963.4887825350957!2d106.81033527411914!3d-6.586001264379522!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69c5d1db517fab%3A0x630f26eae711c5!2sYuma%20Laundry%20(Laundry%20di%20Bogor)!5e0!3m2!1sid!2sid!4v1729678841080!5m2!1sid!2sid"
