    ...
    <div class="w-full md:flex-grow md:pl-12 px-4" data-aos="fade-left" data-aos-duration="1500">
        <form class="space-y-6 bg-[#B3DAF7] p-6 rounded-lg shadow-md md:max-w-[80%] max-w-lg mx-auto">
            <div>
                ...
                <input type="text" id="username" value="{{ $user->username }}"class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
            </div>

            <div>
                <label for="phone" class="block text-sm font-medium text-black">No. Telephone</label>
                <input type="text" id="phone" value="{{ $user->phone_number }}"class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
            </div>

            <div>
                <label for="email" class="block text-sm font-medium text-black">Email</label>
                <input type="email" id="email" value="{{ $user->email }}"class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
            </div>
            ...
            <div class="flex flex-col space-y-4 md:flex-row md:justify-between md:space-y-0">
                ...
                <div class="flex space-x-4">
                    <button type="button" class="bg-[#0F67B1] hover:bg-[#F7FEFF] hover:text-black text-white px-4 py-2 rounded-md w-full md:w-auto"
                    onclick="window.location.href='{{ route('user.logout') }}'">Log Out</button>
                    <a href="{{ route('user.edit') }}" class="bg-[#0F67B1] hover:bg-[#F7FEFF] hover:text-black text-white px-4 py-2 rounded-md w-full md:w-auto">Edit Profil</a>
                </div>
            </div>
        </form>
    </div>
