    ...
    <main class="ease-soft-in-out xl:ml-68.5 relative h-full max-h-screen rounded-xl transition-all duration-200">
        ...
        <div class="w-full px-6 py-6 mx-auto">
            ...
            <div class="flex flex-wrap -mx-3">
                <!-- card2 -->
                <div class="w-full max-w-full px-3 mb-6 sm:w-1/2 sm:flex-none xl:mb-4 xl:w-1/4">
                    <div
                                    ...
                                    <tr>
                                        ...
                                        <td
                                            ...
                                            @elseif($waiting->status == 'belum selesai')
                                                <span
                                                    class="bg-gradient-to-tl from-red-500 to-black px-2.5 text-xs rounded-1.8 py-1.4 inline-block whitespace-nowrap text-center align-baseline font-bold uppercase leading-none text-white">Belum
                                                    Selesai</span>
                                            @elseif($waiting->status == 'dalam antrian')
                                                <span
                                                    class="bg-gradient-to-tl from-slate-600 to-slate-950 px-2.5 text-xs rounded-1.8 py-1.4 inline-block whitespace-nowrap text-center align-baseline font-bold uppercase leading-none text-white">Dalam
                                                    Antrian</span>
                                            @elseif($waiting->status == 'sedang proses')
                                                <span
                                                    class="bg-gradient-to-tl from-slate-600 to-slate-950 px-2.5 text-xs rounded-1.8 py-1.4 inline-block whitespace-nowrap text-center align-baseline font-bold uppercase leading-none text-white">Sedang
                                                    Diproses</span>
                                            @else
                                                <span
                                                    class="bg-gradient-to-tl from-gray-400 to-gray-600 px-2.5 text-xs rounded-1.8 py-1.4 inline-block whitespace-nowrap text-center align-baseline font-bold uppercase leading-none text-white">{{ ucfirst($waiting->status) }}</span>
                                            @endif
                                        </td>
                                        <td
                                            class="p-2 text-center align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                            <span
                                                class="text-xs font-semibold leading-tight text-slate-400">{{ Carbon::parse($waiting->end_date)->format('d/m/Y') }}</span>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
